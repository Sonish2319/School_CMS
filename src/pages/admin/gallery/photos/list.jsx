...
export default function CalendarEventList() {
  ...
  const moduleName = "gallery/photos";
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 bg-gradient-to-r from-green-500 to-green-700 px-4 py-4 rounded-2xl">
        <div>
          <h1 className="text-[22px] sm:text-[26px] font-semibold text-white">Calendar Events</h1>
          <p className="text-white/90 text-sm sm:text-base">Manage academic calendar events</p>
        </div>
        <div>
      ...
      <div className="table-container border border-gray-300">
        <div className="py-6 border-b border-gray-300">
          <div className="flex gap-[10px] px-3 sm:px-6 ">
            ...
            <p className="text-[20px] font-medium text-gray-700">Calendar Event List</p>
          </div>
        </div>
        <Table
          columns={columns.galleryPhotos}
