...
export default function HeroForm({ mode = "add" }) {
  ...
  const { data, error: fetchError, loading } = useFetchData(
    isEditMode ? `aboutus/hero/${id}` : null
  );
...
//     const url = isEditMode ? `aboutus/hero/${id}` : `aboutus/hero`;
  
//     const requestData = new FormData();
//     requestData.append("title", formData.title);
//     if (formData.background_image) {
//         requestData.append("background_image", formData.background_image);
//       }
      
  
//     try {
//       await sendRequest(url, method, requestData, true);
//       router.push("/admin/aboutus/hero/list");
//     } catch (err) {
