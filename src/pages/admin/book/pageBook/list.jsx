...
export default function PageList() {
  ...
  const moduleName = "book/pages";
  const edit = "book/pageBook"
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      {/* Header Section */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 bg-gradient-to-r from-purple-500 to-indigo-700 px-4 py-4 rounded-2xl">
        <div>
          <h1 className="text-[22px] sm:text-[26px] font-semibold text-white">Pages</h1>
          <p className="text-white/90 text-sm sm:text-base">Manage pages for each subject</p>
        </div>
        <div>
      ...
      <div className="table-container border border-gray-300">
        <div className="py-6 border-b border-gray-300">
          <div className="flex gap-[10px] px-3 sm:px-6">
            ...
            <p className="text-[20px] font-medium text-gray-700">Page List</p>
          </div>
        </div>
        ...
        <Table
          ...
          loading={loading}
          error={error}
          onEdit={(id) => handleEditPath(router, edit, id)}
